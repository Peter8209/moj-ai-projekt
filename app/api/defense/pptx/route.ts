...
function addBackground(slide: pptxgen.Slide, theme: PptTheme) {
...
function addFooter(slide: pptxgen.Slide, theme: PptTheme, slideNumber: number) {
...
function addSpeakerNotes(slide: pptxgen.Slide, notes?: string) {
...
function addTable(slide: pptxgen.Slide, theme: PptTheme, table: DefenseTable) {
