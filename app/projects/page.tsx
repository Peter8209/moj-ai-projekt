            ...
            <div className="space-y-9">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <button
                  onClick={generate}
                  disabled={loading}
                  className="inline-flex flex-1 items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-violet-600 to-blue-600 px-6 py-4 text-base font-black text-white shadow-lg shadow-violet-700/30 transition hover:from-violet-500 hover:to-blue-500 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {loading ? (
                    <>
