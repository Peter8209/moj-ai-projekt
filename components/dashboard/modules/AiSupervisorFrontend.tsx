...
function createClientRequestId(prefix = "supervisor"): string {
  const id =
 ...
 * modulu. Modul je pevne nastavený na hodnotu „supervisor“.
 */
export type AiSupervisorFrontendProps = {
...
export default function AiSupervisorFrontend(
  _runtimeProps: AiSupervisorFrontendProps = {},
) {
  const moduleKey: ModuleKey = "supervisor";
