...
/**
 * Verejný kontrakt samostatného frontendu modulu Analýza dát.
 *
 * Modul si naďalej spravuje vlastný stav a serverové načítanie údajov, ale
 * musí vedieť prijať spoločné runtime props, ktoré mu odovzdáva
 * app/dashboard/modules/_shared/useModuleRuntime.ts.
 *
 * Všetky položky sú voliteľné, pretože komponent sa môže používať aj priamo
 * bez ModulePageFrame. Index signature zachová kompatibilitu s budúcimi
 * doplneniami spoločného runtime kontraktu bez použitia `any`.
 */
export type DataAnalysisFrontendProps = {
...
function createClientRequestId(prefix = "data"): string {
  const id =
...
/**
 * Úplne samostatný frontend modulu „Analýza dát“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „data“.
 */
export default function DataAnalysisFrontend(
  _runtimeProps: DataAnalysisFrontendProps = {},
) {
  const moduleKey: ModuleKey = "data";
