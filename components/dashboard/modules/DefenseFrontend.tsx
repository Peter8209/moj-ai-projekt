...
/**
 * Spoločný kontrakt vlastností, ktoré odovzdáva useModuleRuntime
 * samostatnému frontendu modulu Obhajoba.
 *
 ...
 */
export type DefenseFrontendProps = {
...
/**
 * Úplne samostatný frontend modulu „Obhajoba“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „defense“.
 */
export default function DefenseFrontend(
  _runtimeProps: DefenseFrontendProps = {},
) {
  const moduleKey: ModuleKey = "defense";
