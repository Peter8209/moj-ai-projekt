...
function createClientRequestId(prefix = "emails"): string {
  const id =
...
/**
 * Úplne samostatný frontend modulu „Emaily“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „emails“.
 */
export type EmailsFrontendProps = {
  ...
  /**
   * Komponent zostáva kompatibilný aj s ďalšími runtime vlastnosťami,
   * ktoré môže spoločný useModuleRuntime doplniť v budúcnosti.
   */
  readonly [key: string]: unknown;
};

export default function EmailsFrontend(
  _runtimeProps: EmailsFrontendProps = {},
) {
  const moduleKey: ModuleKey = "emails";
