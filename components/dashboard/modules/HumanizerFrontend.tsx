...
function createClientRequestId(prefix = "humanizer"): string {
  const id =
...
/**
 * Úplne samostatný frontend modulu „Humanizátor“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „humanizer“.
 */
export type HumanizerFrontendProps = {
...
export default function HumanizerFrontend(
  _runtimeProps: HumanizerFrontendProps = {},
) {
  const moduleKey: ModuleKey = "humanizer";
