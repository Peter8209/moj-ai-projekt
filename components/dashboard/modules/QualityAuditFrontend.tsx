...
function createClientRequestId(prefix = "quality"): string {
  const id =
...
/**
 * Úplne samostatný frontend modulu „Audit kvality“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „quality“.
 */
export type QualityAuditFrontendProps = {
...
export default function QualityAuditFrontend(
  _runtimeProps: QualityAuditFrontendProps = {},
) {
  const moduleKey: ModuleKey = "quality";
