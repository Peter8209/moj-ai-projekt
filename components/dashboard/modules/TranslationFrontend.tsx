...
function createClientRequestId(prefix = "translation"): string {
  const id =
...
/**
 * Úplne samostatný frontend modulu „Preklad“.
 *
 ...
 * modulu. Modul je pevne nastavený na hodnotu „translation“.
 */
export type TranslationFrontendProps = {
...
export default function TranslationFrontend(
  _runtimeProps: TranslationFrontendProps = {},
) {
  const moduleKey: ModuleKey = "translation";
